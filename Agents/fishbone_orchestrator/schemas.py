...
class WhyAnalysisInput(BaseModel):
    ...
    Optional fields control analysis behavior and provide evidence
    """
    ...
    max_depth: Optional[int] = Field(
        default=100,
        description="Maximum number of Why iterations to perform (default: 100, effectively unlimited)"
    )
    
    # Evidence and investigation data for Validation Agent
    evidence_files: Optional[List[str]] = Field(
        default=None,
        description="List of file paths for evidence documents (PDF, DOCX, XLSX, images, txt/log)"
    )
    logs: Optional[Any] = Field(
        default=None,
        description="Operational logs or event logs"
    )
    reports: Optional[Any] = Field(
        default=None,
        description="Investigation reports and test reports"
    )
    process_data: Optional[Any] = Field(
        default=None,
        description="Manufacturing/process data records"
    )
    historical_capa: Optional[Any] = Field(
        default=None,
        description="Historical CAPA references"
    )
    policies: Optional[Any] = Field(
        default=None,
        description="Policies related to process/compliance"
    )
    investigation_records: Optional[Any] = Field(
        default=None,
        description="General investigation records"
    )
    supporting_system_information: Optional[Any] = Field(
        default=None,
        description="Additional system context (MES, ERP, etc.)"
    )
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "evidence_files": ["evidence/compression_logs.txt", "evidence/dissolution_report.pdf"]
            }
        }
...
class WhyIterationDetail(BaseModel):
    ...
    selection_justification: Optional[str] = Field(None, description="Justification for why this cause was selected")
